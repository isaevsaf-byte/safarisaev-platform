    ...
    ru: {
        red: {
            ...
            pitch: {
                ...
                desc: "Я захожу как внешний управляющий (Crisis CPO). За 30 дней мы перекрываем каналы утечки денег и возвращаем вам физический контроль над финансовым потоком."
            }
        },
        yellow: {
