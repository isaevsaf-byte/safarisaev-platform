...
export const generateEfficiencyReport = async (
    ...
    try {
        ...
        // Surfaced by the caller as inline UI. Swallowing it here and firing an
        // alert() meant the user got a browser dialog saying "check console"
        // immediately after handing over their email address.
